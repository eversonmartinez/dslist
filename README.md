Projeto para estudos do framework para Java: <b>Spring Boot</b>. Esse framework é utilizado para requisições web seguindo o padrão API Rest para o back-end. </br>
